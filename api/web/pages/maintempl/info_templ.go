...
func Contact() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var6 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			ctx = templ.InitializeContext(ctx)
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<main class=\"max-w-6xl mx-auto pt-16 p-8 min-h-screen pb-24\"><!-- Header Section --><header class=\"text-center mb-12\"><h1 class=\"text-4xl font-bold text-gray-800\">Contact Us</h1><p class=\"text-lg text-gray-600 mt-4\">We'd love to hear from you! Reach out to us with any questions, feedback, or inquiries.</p></header><!-- Contact Form Section --><div class=\"bg-white p-8 rounded-lg shadow-xl hover:shadow-2xl transition duration-300 transform hover:scale-105\"><h2 class=\"text-2xl font-bold text-gray-800 mb-6\">Get in Touch</h2><form hx-post=\"/contact\" hx-target=\"body\"><div class=\"mb-6 animate__animated animate__fadeInLeft\"><label for=\"name\" class=\"block text-gray-700 font-semibold\">Name</label> <input type=\"text\" id=\"name\" name=\"name\" required class=\"mt-3 p-4 w-full border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-400 focus:outline-none transition duration-300\" placeholder=\"Your Name\"></div><div class=\"mb-6 animate__animated animate__fadeInRight\"><label for=\"email\" class=\"block text-gray-700 font-semibold\">Email</label> <input type=\"email\" id=\"email\" name=\"email\" required class=\"mt-3 p-4 w-full border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-400 focus:outline-none transition duration-300\" placeholder=\"Your Email\"></div><div class=\"mb-6 animate__animated animate__fadeInUp\"><label for=\"message\" class=\"block text-gray-700 font-semibold\">Message</label> <textarea id=\"message\" name=\"message\" required class=\"mt-3 p-4 w-full border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-400 focus:outline-none transition duration-300\" rows=\"4\" placeholder=\"Your Message\"></textarea></div><button type=\"submit\" class=\"bg-indigo-600 text-white py-3 px-8 rounded-lg hover:bg-indigo-700 transition duration-300 transform hover:scale-105 animate__animated animate__fadeInUp\">Send Message</button></form></div><!-- Additional Contact Information Section --><section class=\"mt-16 text-center\"><h2 class=\"text-2xl font-bold text-gray-800 mb-4\">Other Ways to Reach Us</h2><p class=\"text-gray-600 text-lg mb-6\">Feel free to contact us through any of the following channels:</p><div class=\"flex flex-col md:flex-row justify-center items-center space-y-6 md:space-y-0 md:space-x-12 animate__animated animate__fadeInUp\"><div class=\"bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300 transform hover:scale-105\"><h3 class=\"text-lg font-semibold text-gray-800\">Email</h3><p class=\"text-gray-600 mt-2\">support@emailkeywordfinder.com</p></div><div class=\"bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300 transform hover:scale-105\"><h3 class=\"text-lg font-semibold text-gray-800\">Phone</h3><p class=\"text-gray-600 mt-2\">+1 (123) 456-7890</p></div><div class=\"bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300 transform hover:scale-105\"><h3 class=\"text-lg font-semibold text-gray-800\">Social Media</h3><p class=\"text-gray-600 mt-2\">Follow us on Twitter, LinkedIn, and Facebook</p></div></div></section></main>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			return templ_7745c5c3_Err
		})
		templ_7745c5c3_Err = layout.Base("Contact").Render(templ.WithChildren(ctx, templ_7745c5c3_Var6), templ_7745c5c3_Buffer)
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return templ_7745c5c3_Err
